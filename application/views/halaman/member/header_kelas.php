        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav" style="font-size: 20px; font-weight: bold; color: #373A40;">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="<?= base_url('member/aktivitas/') ?>">Aktivitas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="<?= base_url('member/akademi/') ?>">Akademik</a>
                    </li>
                </ul>
                <ul class="navbar-nav">
                    <!-- kondisi -->
