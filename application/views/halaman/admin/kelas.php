...
<div class="main-content">
    <section class="section">
        ...
        <div class="card">
            <div class="card-body">
                <a style="background-color: #373A40;" href="<?php echo base_url('admin/tambahPaket') ?>" class="btn btn-secondary mb-3">Tambah Kelas</a>
                <?php if ($kelas) : ?>
                    <div class="row">
                            ...
                            <div class="col-md-3 mb-4">
                                <div class="card" style="width: 100%; margin-bottom: 0;">
                                    ...
                                    <div class="card-body" style="padding: 10px;">
                                        ...
                                        <p class="card-text" style="font-size: 0.9rem; margin-bottom: 10px;">Siswa terdaftar: <?= $k->terdaftar ?></p>
                                        <hr>
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <a href="<?= base_url('admin/dataKelas/') . $k->id ?>" class="btn btn-outline-secondary ml-2" style="font-size: 0.9rem; padding: 5px 10px;">Data siswa</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
