...
<body>
    ...
    <br>
    <br>
    <div class="container p-0 " style="width: 85%; height:500px">
            ...
            <div class="row g-0">
                <div class="col-12 col-lg-5 col-xl-3 border-right">
                    ...
                    <?php foreach ($user as $a) : ?>
                        <a href="<?= base_url('chat/message/') . strtolower(str_replace(' ', '-', $a['kelas']->judul_paket)) . '-' . $a['kelas']->kelas_id . '/' . $a['user']['id'] ?>" class="list-group-item list-group-item-action border-0">
                            <div class="badge bg-success float-right">5</div>
                            <div class="d-flex align-items-start">
                                <img src="https://bootdey.com/img/Content/avatar/avatar5.png" class="rounded-circle mr-1" alt="Vanessa Tucker" width="40" height="40">
                                <div class="flex-grow-1 ml-3">
                                    <?= $a['user']['nama_pengguna'] ?>
