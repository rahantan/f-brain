...
<head>
    ...
    <style>
        .bg-gradient-primary {
            ...
            /* Menghapus gambar latar belakang gradient jika ada */
        }
    </style>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
                <div class="sidebar-brand-icon">
                    <img src="<?= base_url('assets/img/logo.png') ?>" alt="" style="width: 50px; height: auto;">
                </div>
                <div class="sidebar-brand-text mx-3">F-Brain</div>
            </a>
            <!-- Divider -->
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('admin/tambahKelas/') ?>">Create Kelas</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!-- Nav Item - Messages -->
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-togge" href="<?= base_url('admin/chat') ?>" id="messagesDropdown" role="buton" data-toggle="dropown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="https://d17ivq9b7rppb3.cloudfront.net/original/academy/belajar_membuat_aplikasi_android_untuk_pemula_logo_230421132330.jpg">
                            </a>
